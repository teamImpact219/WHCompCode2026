...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    private final SwerveRequest.ApplyRobotSpeeds chassisSpeedsSwerveRequests = new SwerveRequest.ApplyRobotSpeeds();
    ...
    public void configurePathPlanner() {
        ...
        try {
            ...
            AutoBuilder.configure(
                    () -> this.getState().Pose, // Supplier: How to GET the pose
                    this::resetPose, // Method to reset odometry (will be called if your auto has a starting pose)
                    () -> this.getState().Speeds, // Supplier: How to GET robot speeds
